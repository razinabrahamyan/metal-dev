                                        ...
                                        <div class="action-tags">
                                            ...
                                            <div class="form-group position-relative">
                                                ...
                                                <select class="select2 form-control" id="task-assigned" name="task-assigned">
                                                    ...
                                                    <option data-img="{{asset('admin/app-assets/images/portrait/small/avatar-s-3.jpg')}}" value="Phill Buffer">
                                                        Phill Buffer
                                                    </option>
                                                    <option data-img="{{asset('admin/app-assets/images/portrait/small/avatar-s-1.jpg')}}" value="Chandler Bing">
                                                        Chandler Bing
                                                    </option>
                                                    <option data-img="{{asset('admin/app-assets/images/portrait/small/avatar-s-4.jpg')}}" value="Ross Geller">
                                                        Ross Geller
                                                    </option>
                                                    <option data-img="{{asset('admin/app-assets/images/portrait/small/avatar-s-6.jpg')}}" value="Monica Geller">
                                                        Monica Geller
                                                    </option>
                                                    <option data-img="{{asset('admin/app-assets/images/portrait/small/avatar-s-2.jpg')}}" value="Joey Tribbiani">
                                                        Joey Tribbiani
                                                    </option>
                                                    <option data-img="{{asset('admin/app-assets/images/portrait/small/avatar-s-11.jpg')}}" value="Rachel Green">
                                                        Rachel Green
                                                    </option>
                                                </select>
                                            </div>
...
@push('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin/app-assets/vendors/css/extensions/dragula.min.css')}}">
