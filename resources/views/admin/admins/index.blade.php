                                            ...
                                            <td>
                                                <div class="d-flex justify-content-left align-items-center">
                                                    <div class="avatar  mr-1"><img
                                                            src="{{asset('admin/app-assets/images/avatars/'.$admin->id.'-small.png')}}" alt="Avatar"
                                                            width="32" height="32"></div>
                                                    <div class="d-flex flex-column"><span
                                                            class="emp_name text-truncate font-weight-bold">{{$admin['first_name']}} {{$admin->last_name}}</span><small
                                                            class="emp_post text-truncate text-muted">Paralegal</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{$admin->email}}</td>
