                                        ...
                                        <div class="col-xl-6 col-lg-12 d-flex flex-column justify-content-between border-container-lg">
                                            <div class="user-avatar-section">
                                                <div class="d-flex justify-content-start">
                                                    <img class="img-fluid rounded" src="{{asset('admin/app-assets/images/avatars/'.$admin->id.'.png')}}" height="104" width="104" alt="User avatar" />
                                        ...
                                        <div class="col-xl-6 col-lg-12 mt-2 mt-xl-0">
                                            <div class="user-info-wrapper">
                                                <div class="d-flex flex-wrap my-50">
                                                    ...
                                                    <p class="card-text mb-0">{{ucfirst($admin->status)}}</p>
                                                </div>
                                                <div class="d-flex flex-wrap my-50">
                                                    <div class="user-info-title">
                                                    ...
                                                    <p class="card-text mb-0">{{$admin->role['name']}}</p>
                                                </div>
                                                <div class="d-flex flex-wrap my-50">
                                                    <div class="user-info-title">
...
@push('scripts')
    ...
    <script src="{{asset('admin/app-assets/js/scripts/pages/app-user-view.js')}}"></script>
@endpush
