                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="card basic-pricing text-center">
                                    <div class="card-body">
                                        <img src="{{asset('admin/app-assets/images/illustration/Pot1.svg')}}" class="mb-2 mt-5" alt="svg img" />
                                        <h3>Basic</h3>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="card standard-pricing popular text-center">
                                    <div class="card-body">
                                        ...
                                        <img src="{{asset('admin/app-assets/images/illustration/Pot2.svg')}}" class="mb-1" alt="svg img" />
                                        <h3>Standard</h3>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="card enterprise-pricing text-center">
                                    <div class="card-body">
                                        <img src="{{asset('admin/app-assets/images/illustration/Pot3.svg')}}" class="mb-2" alt="svg img" />
                                        <h3>Enterprise</h3>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-10 col-lg-offset-3 mx-auto">
                            <div class="pricing-trial-content d-flex justify-content-between">
                                ...
                                <!-- image -->
                                <img src="{{asset('admin/app-assets/images/illustration/pricing-Illustration.svg')}}" class="pricing-trial-img img-fluid" alt="svg img" />
                            </div>
                        </div>
                    </div>
                </div>
...
@endsection
@push('styles')
    <link rel="stylesheet" type="text/css" href="{{asset('admin/app-assets/css/pages/page-pricing.css')}}">
@endpush
@push('scripts')
    <script src="{{asset('admin/app-assets/js/scripts/pages/page-pricing.js')}}"></script>
@endpush
