var infoBox_ratingType='star-rating';(function($){
    "use strict";
    function mainMap() {
        var ib=new InfoBox();
        ...
        var map=new google.maps.Map(document.getElementById('map'),{
            ...
            center:new google.maps.LatLng(40.80,-73.70),mapTypeId:google.maps.MapTypeId.ROADMAP,
            zoomControl:false,
        ...
        $('.listing-item-container').on('mouseover',function(){
            ...
            if(listingAttr!==undefined){
                ...
                $(this).on('mouseout',function(){
                    if($(marker_div).is(":not(.infoBox-opened)")){$(marker_div).removeClass('clicked');
                    }
                });
            }
        });
        ...
        var boxOptions={
            ...
            zIndex:null,boxStyle:{width:"320px"},
            closeBoxMargin:"0",closeBoxURL:"",
        ...
        for(i=0;i<locations.length;i++){
            ...
            allMarkers.push(overlay);google.maps.event.addDomListener(overlay,'click',(function(overlay,i){
                return function(){
                    ib.setOptions(boxOptions);
                    boxText.innerHTML=locations[i][0];
                    ib.close();ib.open(map,overlay);
